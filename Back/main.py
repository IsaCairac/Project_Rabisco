...
# FUNÇÂO PARA CONECTAR COM O BANCO DE DADOS
def conecta_bd():
    # * pega toda a linha e coloca como parametro, desempacota 
    conexaoDB = mysql.connector.connect(**DB_CONFIG)
    cursorDB = conexaoDB.cursor()
    return conexaoDB, cursorDB

#FUNÇÃO IRA FECHAR CONEXÃO COM O DB
